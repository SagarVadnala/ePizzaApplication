...
namespace ePizza.Infrastructure.Models;

public partial class EPizzaDBbContext : DbContext
{
    public EPizzaDBbContext(DbContextOptions<EPizzaDBbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserToke__3214EC0745A6B6B5");
