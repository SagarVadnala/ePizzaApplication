...
public partial class ePizzaAppContext : DbContext
{
    public ePizzaAppContext(DbContextOptions<ePizzaAppContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserToke__3214EC0741908861");
